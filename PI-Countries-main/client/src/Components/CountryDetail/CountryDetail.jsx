...
import detail from "../../img/fondo-detail.jpg";
  ...
  return (
    <div className="container_page">
        ...
        <div className="activity">
          ...
          <div className="list">
            {country.activities?.map((e) => {
              let season;
              if (e.season === "Winter") season = <span>⛄</span>;
              if (e.season === "Summer") season = <span>🌞</span>;
              if (e.season === "Spring") season = <span>🌼</span>;
              if (e.season === "Autumn") season = <span>🍂</span>;
              return (
                <details>
                  <summary>{e.name}</summary>
                  <p key={e.id}>🅽ame: {e.name} </p>
      ...
      <div className="wallpaper">
        <img className="stretch" src={detail} alt="" />
      </div>
    </div>
  );
}